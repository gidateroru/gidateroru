...
<div class="container">
    ...
    {% for a in site.data.tob13012020.et_ve_et_urunleri_other_part_1 %}
    {% include list-item.html row=a %}
    {% endfor %}

    {% for a in site.data.tob13012020.et_ve_et_urunleri_other_part_2 %}
    {% include list-item.html row=a %}
    {% endfor %}

    {% for a in site.data.tob13012020.et_ve_et_urunleri_other_part_3 %}
    {% include list-item.html row=a %}
    {% endfor %}
</div>
